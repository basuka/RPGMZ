 ...
 *    この項目は【転移先名の種類】で「入力」を選択した場合無効となります。
 *
 *      ・移動先のマップ
 ...
 *
 *    【X軸の調整】
 *     この項目は【X軸の調整タイプ】で「なし」以外を選択した場合有効(必須)となります。
 *     転移先X座標の調整数を設定します。
 ...
 *
 *    【Y軸の調整】
 *     この項目は【Y軸の調整タイプ】で「なし」以外を選択した場合有効(必須)となります。
 *     転移先Y座標の調整数を設定します。
 *    【Y軸の調整タイプ】で直接指定を選択した場合は、ここで入力された値が転移先のY座標に設定されます。
 *     また、【転移先マップの種類】で直接指定を選択した場合も同様の設定になります。
 *
 *     (※1)基準座標
 *
 *       ・【転移先マップの種類】で現在のマップを選択した場合
 *          テレポートの設定を行っているイベントの座標
 *
 *       ・【転移先マップの種類】で移動先のマップを選択した場合
 ...
 * ■設定上の注意
 *
 *   1.【テレポートの設定】は必ず、場所移動イベントを行うページ内に設定してください。
 ...
 *
 *   3.【テレポートの設定】を行うイベントの実行はプレイヤーとイベントが重なった時に実行するようにしてください。
