 ...
 * @author Basu
 * @url https://raw.githubusercontent.com/basuka/RPGMZ/main/SlotMachine2/SlotMachine.js
 *
 *
 * @help
 * スロットマシーンの機能を実装します。
 * 旧スロットマシーンへの機能追加が難しいため新規作成となります。
 * そのため、旧スロットマシーンとの互換性はないので、旧プラグインを使用している場合はご注意ください。
 * 詳細については、以下のREADMEを参照してください。
 *
 *-----------------------------------------------------------------------------
 * README
 *-----------------------------------------------------------------------------
 * https://github.com/basuka/RPGMZ/blob/main/SlotMachine2/README.md
 *
 *-----------------------------------------------------------------------------
 * 利用規約
 *-----------------------------------------------------------------------------
